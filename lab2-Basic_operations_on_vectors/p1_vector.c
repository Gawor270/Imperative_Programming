...
int main(void) {
    ...
    if (TEST) scanf("%d", &to_do);

        switch (to_do){
                case 1: // linspace
                    if (TEST) scanf("%d %lf %lf", &len, &start, &stop);
                ...
                case 2: // add
                    if (TEST) scanf("%d", &len);
                if(len < 0 || len > N) { printf("n<0 lub n > 100\n");  break; }
                        if (TEST) read_vector(vector_1, len);
                        if (TEST)
                ...
                if(len < 0 || len > N) { printf("n<0 lub n > 100\n");  break; }
                    if (TEST) read_vector(vector_1, len);
                        if (TEST) read_vector(vector_2, len);
                        printf("%.2f\n", dot_product(vector_1, vector_2, len));
                        break;
                case 4: // multiply by scalar
                    if (TEST) scanf("%d %lf", &len, &scalar);
                if(len < 0 || len > N) { printf("n<0 lub n > 100\n");  break; }
                        ...
                        break;
                case 5: // range
                    if (TEST) scanf("%d %lf %lf", &len, &start, &step);
                if(len < 0 || len > N) { /*printf("n<0 lub n > 100\n")*/;  break; }
